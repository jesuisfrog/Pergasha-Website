...
function classPage() {
    ...
    var barbarian = {
        ...
        featuresDesc:['<tr><td><span class="class-feature-title" id="rage">Rage</span><p>In battle, you fight with primal ferocity. On your turn, you can enter a rage as a bonus action. While raging, you gain the following benefits if you aren\'t wearing heavy armor:</p><ul><li>You have advantage on Strength checks and Strength saving throws.</li><li>When you make a melee weapon attack using Strength, you gain a +2 bonus to the damage roll. This bonus increases as you level.</li><li>You have resistance to bludgeoning, piercing, and slashing damage.</li></ul><p>Rage affects the mind in a way that makes focused thought difficult. While raging, you cannot switch your Psionic Focus or use any effects that require concentration. Any active disciplines requiring your concentration immediately end and their effects dissipate. However, you can activate psionic abilities from disciplines from the Immortal Order that do not require concentration. You also can maintain your rage by attacking enemies with psionic abilities within the Immortal Order.</p><p>Your rage lasts for 1 minute. It ends early if you are knocked unconscious or if your turn ends and you have not attacked a hostile creature since your last turn or taken damage since then. Activities that  qualify for attacking a hostile creature includes weapon attacks, aggressive actions such as grappling, and targeted psionic attacks within the Immortal Order. You can also end your rage on your turn as a bonus action. Once you have raged the maximum number of times for your barbarian level, you must finish a long rest before you can rage again. You may rage 2 times at 1st level, 3 at 3rd, 4 at 6th, 5 at 12th, and 6 at 17th.</p></td></tr>','<tr><td><span class="class-feature-title" id="unarmoredDefense">Unarmored Defense</span><p>While you are not wearing any armor, your Armor Class equals 10 + your Dexterity modifier + your Constitution modifier. You can use a shield and still gain this benefit.</p></td></tr>','<tr><td><span class="class-feature-title" id="dangerSense">Danger Sense</span><p>At 2nd level, you gain an uncanny sense of when things nearby aren\'t as they should be, giving you an edge when you dodge away from danger. You have advantage on Dexterity saving throws against effects that you can see, such as traps and spells. To gain this benefit, you can\'t be blinded, deafened, or incapacitated.</p></td></tr>','<tr><td><span class="class-feature-title" id="naturalist">Naturalist</span><p><i>2nd-level barbarian feature (replaces Danger Sense)</i></p><p>You become proficient in your choice of two of the following skills: Animal Handling, Medicine, Nature, Perception, or Survival.</p><p>Your proficiency bonus is doubled for any ability check you make that uses either of those skills.</p></td></tr>','<tr><td><span class="class-feature-title" id="recklessAttacks">Reckless Attack</span><p>Starting at 2nd level, you can throw aside all concern for defense to attack with fierce desperation. When you make your first attack on your turn, you can decide to attack recklessly. Doing so gives you advantage on melee weapon attack rolls using Strength during this turn, but attack rolls against you have advantage until your next turn.</p></td></tr>','<tr class="archetype-features"><td><span class="class-feature-title" id="primalPath">Primal Path</span><p>At 3rd level, you choose a path that shapes the nature of your rage from the list of available paths. Your choice grants you features at 3rd level and again at 6th, 10th, and 14th levels.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi4">Ability Score Improvement</span><p>When you reach 4th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM allows the use of feats, you may instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="extraAttack">Extra Attack</span><p>Beginning at 5th level, you can attack twice, instead of once, whenever you take the Attack action on your turn.</p></td></tr>','<tr><td><span class="class-feature-title" id="fastMovement">Fast Movement</span><p>Starting at 5th level, your speed increases by 10 feet while you aren\'t wearing heavy armor.</p></td></tr>','<tr><td><span class="class-feature-title" id="instinctivePounce">Instinctive Pounce</span><p><i>5th-level barbarian feature (replaces Fast Movement)</i></p><p>When a creature ends its turn within 15 feet of you, you can use your reaction to move up to half your speed to a space closer to the creature. This movement doesn\'t provoke opportunity attacks.</p></td></tr>','<tr class="archetype-features"><td><span class="class-feature-title" id="pathFeature1">Path Feature</span><p>At 6th level, you gain a feature from your Primal Path.</p></td></tr>','<tr><td><span class="class-feature-title" id="feralInstincts">Feral Instinct</span><p>By 7th level, your instincts are so honed that you have advantage on initiative rolls.</p><p>Additionally, if you are surprised at the beginning of combat and aren\'t incapacitated, you can act normally on your first turn, but only if you enter your rage before doing anything else on that turn.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi8">Ability Score Improvement</span><p>When you reach 8th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM uses the optional Feats, you can instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="brutalCritical1">Brutal Critical (1 die)</span><p>Beginning at 9th level, you can roll one additional weapon damage die when determining the extra damage for a critical hit with a melee attack.</p><p>This increases to two additional dice at 13th level and three additional dice at 17th level.</p></td></tr>','<tr class="archetype-features"><td><span class="class-feature-title" id="pathFeature2">Path Feature</span><p>At 10th level, you gain a feature from your Primal Path.</p></td></tr>','<tr><td><span class="class-feature-title" id="relentlessRage">Relentless Rage</span><p>Starting at 11th level, your rage can keep you fighting despite grievous wounds. If you drop to 0 hit points while you\'re raging and don\'t die outright, you can make a DC 10 Constitution saving throw. If you succeed, you drop to 1 hit point instead.</p><p>Each time you use this feature after the first, the DC increases by 5. When you finish a short or long rest, the DC resets to 10.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi12">Ability Score Improvement</span><p>When you reach 12th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM uses the optional Feats, you can instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="brutalCritical2">Brutal Critical (2 dice)</span><p>At 13th level, you can roll two additional weapon damage dice when determining the extra damage for a critical hit with a melee attack.</p><p>This increases to three additional dice at 17th level.</p></td></tr>','<tr class="archetype-features"><td><span class="class-feature-title" id="pathFeature3">Path Feature</span><p>At 14th level, you gain a feature from your Primal Path.</p></td></tr>','<tr><td><span class="class-feature-title" id="persistentRage">Persistent Rage</span><p>Beginning at 15th level, your rage is so fierce that it ends early only if you fall unconscious or if you choose to end it.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi16">Ability Score Improvement</span><p>When you reach 16th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM uses the optional Feats, you can instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="brutalCritical3">Brutal Critical (3 dice)</span><p>At 17th level, you can roll three additional weapon damage dice when determining the extra damage for a critical hit with a melee attack.</p></td></tr>','<tr><td><span class="class-feature-title" id="indomitableMight">Indomitable Might</span><p>Beginning at 18th level, if your total for a Strength check is less than your Strength score, you can use that score in place of the total.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi19">Ability Score Improvement</span><p>When you reach 19th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM uses the optional Feats, you can instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="primalChampion">Primal Champion</span><p>At 20th level, you embody the power of the wilds. Your Strength and Constitution scores increase by 4. Your maximum for those scores is now 24.</p></td></tr>'],
        archetypes:[{
            ...
            archetypeFeaturesDesc: ['<tr><td><span class="class-feature-title class-feature-archetype" id="ancestralGuardian">Path of the Ancestral Guardian</span><p>Some barbarians hail from cultures that revere their ancestors. These tribes teach that the warriors of the past linger in the world as mighty spirits, who can guide and protect the living. When a barbarian who follows this path rages, the barbarian contacts the spirit world and calls on these guardian spirits for aid.</p><p>Barbarians who draw on their ancestral guardians can better fight to protect their tribes and their allies. To cement ties to their ancestral guardians, barbarians who follow this path cover themselves in elaborate tattoos that celebrate their ancestors\' deeds. These tattoos tell sagas of victories against terrible monsters and other fearsome rivals.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="ancestralProtector">Ancestral Protectors</span><p>Spectral warriors appear when you enter your rage. While raging, the first creature you hit with an attack on your turn becomes the target of the warriors, which hinder its attacks. Until the start of your next turn, that target has disadvantage on any attack roll that isn\'t against you, and when the target hits a creature other than you with an attack, that creature has resistance to the damage dealt by the attack. The effect on the target ends early if your rage ends.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="spiritShield">Spirit Shield</span><p>The guardian spirits that aid you can provide protection to those you defend. If you are raging and another creature you can see within 30 feet of you takes damage, you can expand your mind to reduce their pain. You may use your reaction to reduce that damage by 2d6.</p><p>When you reach certain levels in this class, you can reduce the damage by more: by 3d6 at 10th level and by 4d6 at 14th level.</p></p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="guided">Guided by the Spirits</span><p>Your ancestral spirits guide you in battle and help you foresee danger. You may use a bonus action to receive momentary insights to improve your odds of success. For the next minute, whenever you make an attack roll, a saving throw, or an ability check, you roll a d4 and add it to the total. Once you use this ability, you cannot do so again until you complete a long rest.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="vengefulAncestors">Vengeful Ancestors</span><p>Your ancestral spirits grow powerful enough to retaliate. When you use your Spirit Shield to reduce the damage of an attack, the attacker takes an amount of psychic damage equal to the damage that your Spirit Shield prevents.</p></td></tr>']
        },{
            ...
            archetypeFeaturesDesc: ['<tr><td><span class="class-feature-title class-feature-archetype" id="battlerager">Path of the Battlerager</span><p>Battleragers barbarians specialize in wearing bulky, spiked armor and throwing themselves into combat, striking with their body itself and giving themselves over to the fury of battle.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="battleragerArmor">Battlerager Armor</span><p>When you choose this path at 3rd level, you gain the ability to use spiked armor as a weapon.</p><p>While you are wearing spiked armor and are raging, you can use a bonus action to make one melee weapon attack with your armor spikes at a target within 5 feet of you. If the attack hits, the spikes deal 1d4 piercing damage. You use your Strength modifier for the attack and damage rolls.</p><p>Additionally, when you use the Attack action to grapple a creature, the target takes 3 piercing damage if your grapple check succeeds.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="recklessAbandon">Reckless Abandon</span><p>Beginning at 6th level, when you use Reckless Attack while raging, you also gain temporary hit points equal to your Constitution modifier (minimum of 1). They vanish if any of them are left when your rage ends.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="battleragerCharge">Battlerager Charge</span><p>Beginning at 10th level, you can take the Dash action as a bonus action while you are raging.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="spikedRetribution">Spiked Retribution</span><p>Starting at 14th level, when a creature within 5 feet of you hits you with a melee attack, the attacker takes 3 piercing damage if you are raging, aren\'t incapacitated, and are wearing spiked armor.</p></td></tr>']
        },{ 
    ...
    var fighter = {
        ...
        extraFeatures: '',
        featuresDesc:['<tr><td><span class="class-feature-title d-flex justify-content-between" id="fstyle"><span>Fighting Style</span><span class="collapsing-button" aria-expanded="false" role="button" onClick=\'collapsingButton(this, "fighting-style-fighter")\'>[+]</span></span><p>You adopt a particular style of fighting as your specialty. Choose one of the following options. You can\'t take the same Fighting Style option more than once, even if you get to choose again. New options outside of the Player’s Handbook are available.</p><span style="display: none" id="fighting-style-fighter"><span class="class-feature-subtitle">Archery</span><p>You gain a +2 bonus to attack rolls you make with ranged weapons.</p><span class="class-feature-subtitle">Blind Fighting</span><p>Being unable to see a creature doesn\'t impose disadvantage on your attack rolls against it, provided the creature isn\'t hidden from you.</p><span class="class-feature-subtitle">Close Quarters Shooter</span><p>When making a ranged attack while you are within 5 feet of a hostile creature, you do not have disadvantage on the attack roll. Your ranged attacks ignore half cover and three-quarters cover against targets within 30 feet of you. You have a +1 bonus to attack rolls on ranged attacks.</p><span class="class-feature-subtitle">Defense</span><p>While you are wearing armor, you gain a +1 bonus to AC.</p><span class="class-feature-subtitle">Dueling</span><p>When you are wielding a melee weapon in one hand and no other weapons, you gain a +2 bonus to damage rolls with that weapon.</p><span class="class-feature-subtitle">Great Weapon Fighting</span><p>When you roll a 1 or 2 on a damage die for an attack you make with a melee weapon that you are wielding with two hands, you can reroll the die and must use the new roll, even if the new roll is a 1 or a 2. The weapon must have the two-handed or versatile property for you to gain this benefit.</p><span class="class-feature-subtitle">Interception</span><p>When a creature you can see hits a target that is within 5 feet of you with an attack, you can use your reaction to reduce the damage the target takes by 1d10 + your proficiency bonus (to a minimum of 0 damage). You must be wielding a shield or a simple or martial weapon to use this reaction.</p><span class="class-feature-subtitle">Protection</span><p>When a creature you can see attacks a target other than you that is within 5 feet of you, you can use your reaction to impose disadvantage on the attack roll. You must be wielding a shield.</p><span class="class-feature-subtitle">Superior Technique</span><p>You learn one maneuver of your choice from among those available to the Battle Master archetype. If a maneuver you use requires your target to make a saving throw to resist the maneuver\'s effects, the saving throw DC equals 8 + your proficiency bonus + your Strength or    Dexterity modifier (your choice).</p><p>You gain one superiority die, which is a d6 (this die is added to any superiority dice you have from another source). This die is used to fuel your maneuvers. A superiority die is expended when you use it. You regain your expended superiority dice when you finish a short or long rest.</p><span class="class-feature-subtitle">Thrown Weapon Fighting</span><p>You can draw a weapon that has the thrown property as part of the attack you make with the weapon.</p><p>In addition, when you hit with a ranged attack using a thrown weapon, you gain a +1 bonus to the damage roll.</p><span class="class-feature-subtitle">Two-Weapon Fighting</span><p>When you engage in two-weapon fighting, you can add your ability modifier to the damage of the second attack.</p></span></td></tr>','<tr><td><span class="class-feature-title" id="secondWind">Second Wind</span><p>You have a limited well of stamina that you can draw on to protect yourself from harm. On your turn, you can use a bonus action to regain hit points equal to 1d10 + your fighter level.</p><p>Once you use this feature, you must finish a short or long rest before you can use it again.</p></td></tr>','<tr><td><span class="class-feature-title" id="actSurge">Action Surge</span><p>Starting at 2nd level, you can push yourself beyond your normal limits for a moment. On your turn, you can take one additional action.</p><p>Once you use this feature, you must finish a short or long rest before you can use it again. Starting at 17th level, you can use it twice before a rest, but only once on the same turn.</p></td></tr>','<tr><td><span class="class-feature-title" id="martialArc">Martial Archetype</span><p>At 3rd level, you choose an archetype from the list available that you strive to emulate in your combat styles and techniques. The archetype you choose grants you features at 3rd level and again at 7th, 10th, 15th, and 18th level.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi4">Ability Score Improvement</span><p>When you reach 4th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM allows the use of feats, you may instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="extraAttack">Extra Attack</span><p>Beginning at 5th level, you can attack twice, instead of once, whenever you take the Attack action on your turn.</p><p>The number of attacks increases to three when you reach 11th level in this class and to four when you reach 20th level in this class.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi6">Ability Score Improvement</span><p>When you reach 6th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM allows the use of feats, you may instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="martialArc1">Martial Archetype Feature</span><p>At 7th level, you gain a feature granted by your Martial Archetype.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi8">Ability Score Improvement</span><p>When you reach 8th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM allows the use of feats, you may instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="indomitable">Indomitable</span><p>Beginning at 9th level, you can reroll a saving throw that you fail. If you do so, you must use the new roll, and you can\'t use this feature again until you finish a long rest.</p><p>You can use this feature twice between long rests starting at 13th level and three times between long rests starting at 17th level.</p></td></tr>','<tr><td><span class="class-feature-title" id="martialArc2">Martial Archetype Feature</span><p>At 10th level, you gain a feature granted by your Martial Archetype.</p></td></tr>','<tr><td><span class="class-feature-title" id="extraAttack2">Extra Attack (2)</span><p>At 11th level, you can attack three times whenever you take the Attack action on your turn.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi12">Ability Score Improvement</span><p>When you reach 12th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM allows the use of feats, you may instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="indomitable2">Indomitable (two uses)</span><p>At 13th level, you can use Indomitable twice between long rests.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi14">Ability Score Improvement</span><p>When you reach 14th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM allows the use of feats, you may instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="martialArc3">Martial Archetype Feature</span><p>At 15th level, you gain a feature granted by your Martial Archetype.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi16">Ability Score Improvement</span><p>When you reach 16th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM allows the use of feats, you may instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="actSurge2">Action Surge (two uses)</span><p>At 17th level, you can use Action Surge twice before a rest, but only once on the same turn.</p></td></tr>','<tr><td><span class="class-feature-title" id="indomitable3">Indomitable (three uses)</span><p>At 17th level, you can use Indomitable three times between long rests.</p></td></tr>','<tr><td><span class="class-feature-title" id="martialArc4">Martial Archetype Feature</span><p>At 18th level, you gain a feature granted by your Martial Archetype.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi19">Ability Score Improvement</span><p>When you reach 19th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM allows the use of feats, you may instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="extraAttack3">Extra Attack (3)</span><p>At 20th level, you can attack four times whenever you take the Attack action on your turn.</p></td></tr>'],
        archetypes:[{
            ...
            archetypeFeaturesDesc: ['<tr><td><span class="class-feature-title class-feature-archetype" id="brute">Brute</span><p>Brutes are simple warriors who rely on mighty attacks and their own durability to overcome their enemies. Some brutes combine this physical might with tactical cunning. Others just hit things until those things stop hitting back.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="bruteForce">Brute Force</span><p>Starting at 3rd level, you\'re able to strike with your weapons with especially brutal force. Whenever you hit with a weapon that you\'re proficient with and deal damage, the weapon\'s damage increases by an amount based on your level in this class, as shown on the following table.</p><table class="table table-striped table-bordered"><th class="text-center">Fighter Level</th><th class="text-center">Damage Increase</th></tr><tr><td class="text-center">3rd</td><td class="text-center">1d4</td></tr><tr><td class="text-center">10th</td><td class="text-center">1d6</td></tr><tr><td class="text-center">16th</td><td class="text-center">1d8</td></tr><tr><td class="text-center">20th</td><td class="text-center">1d10</td></tr></table></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="brutish">Brutish Durability</span><p>Beginning at 7th level, your toughness allows you to shrug off assaults that would devastate others.</p><p>Whenever you make a saving throw, roll 1d6 and add the die to your saving throw total. If applying this bonus to a death saving throw increases the total to 20 or higher, you gain the benefits of rolling a 20 on the d20.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="addFstyle">Additional Fighting Style</span><p>At 10th level, you can choose a second option from the Fighting Style feature.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="devastating">Devastating Critical</span><p>Starting at 15th level, when you score a critical hit with a weapon attack, you gain a bonus to that weapon\'s damage roll equal to your level in this class.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="survivor">Survivor</span><p>At 18th level, you attain the pinnacle of resilience in battle. At the start of each of your turns in combat, you regain hit points equal to 5 + your Constitution modifier (minimum of 1 hit point). You don\'t gain this benefit if you have 0 hit points or if you have more than half of your hit points left.</p></td></tr>']
        },{
            ...
            archetypeFeaturesDesc: ['<tr><td><span class="class-feature-title class-feature-archetype" id="cavalier">Cavalier</span><p>The archetypal Cavalier excels at mounted combat. Usually born among the nobility and raised at court, a Cavalier is equally at home leading a cavalry charge or exchanging repartee at a state dinner. Cavaliers also learn how to guard those in their charge from harm, often serving as the protectors of their superiors and of the weak. Compelled to right wrongs or earn prestige, many of these fighters leave their lives of comfort to embark on glorious adventure.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="bonprof">Bonus Proficiency</span><p>When you choose this archetype at 3rd level, you gain proficiency in one of the following skills of your choice: Animal Handling, History, Insight, Performance, or Persuasion. Alternatively, you learn one language of your choice.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="saddle">Born to the Saddle</span><p>Starting at 3rd level, your mastery as a rider becomes apparent. You have advantage on saving throws made to avoid falling off your mount. If you fall off your mount and descend no more than 10 feet, you can land on your feet if you\'re not incapacitated.</p><p>Finally, mounting or dismounting a creature costs you only 5 feet of movement, rather than half your speed.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="unwaveringMark">Unwavering Mark</span><p>Starting at 3rd level, you can menace your foes, foiling their attacks and punishing them for harming others. When you hit a creature with a melee weapon attack, you can mark the creature until the end of your next turn. This effect ends early if you are incapacitated or you die, or if someone else marks the creature.</p><p>While it is within 5 feet of you, a creature marked by you has disadvantage on any attack roll that doesn\'t target you.</p><p>In addition, if a creature marked by you deals damage to anyone other than you, you can make a special melee weapon attack against the marked creature as a bonus action on your next turn. You have advantage on the attack roll, and if it hits, the attack\'s weapon deals extra damage to the target equal to half your fighter level.</p><p>Regardless of the number of creatures you mark, you can make this special attack a number of times equal to your Strength modifier (minimum of once), and you regain all expended uses of it when you finish a long rest.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="wardingManeuvers">Warding Maneuver</span><p>At 7th level, you learn to fend off strikes directed at you, your mount, or other creatures nearby. If you or a creature you can see within 5 feet of you is hit by an attack, you can roll 1d8 as a reaction if you\'re wielding a melee weapon or a shield. Roll the die, and add the number rolled to the target\'s AC against that attack. If the attack still hits, the target has resistance against the attack\'s damage.</p><p>You can use this feature a number of times equal to your Constitution modifier (minimum of once), and you regain all expended uses of it when you finish a long rest.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="holdLine">Hold the Line</span><p>At 10th level, you become a master of locking down your enemies. Creatures provoke an opportunity attack from you when they move 5 feet or more while within your reach, and if you hit a creature with an opportunity attack, the target\'s speed is reduced to 0 until the end of the current turn.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="ferocious">Ferocious Charger</span><p>Starting at 15th level, you can run down your foes, whether you\'re mounted or not. If you move at least 10 feet in a straight line right before attacking a creature and you hit it with the attack, that target must succeed on a Strength saving throw (DC 8 + your proficiency bonus + your Strength modifier) or be knocked prone. You can use this feature only once on each of your turns.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="vigilant">Vigilant Defender</span><p>Starting at 18th level, you respond to danger with extraordinary vigilance. In combat, you get a special reaction that you can take once on every creature\'s turn, except your turn. You can use this special reaction only to make an opportunity attack, and you can\'t use it on the same turn that you take your normal reaction.</p></td></tr>']
        },{
            ...
            archetypeFeaturesDesc: ['<tr><td><span class="class-feature-title class-feature-archetype" id="champion">Champion</span><p>The archetypal Champion focuses on the development of raw physical power honed to deadly perfection. Those who model themselves on this archetype combine rigorous training with physical excellence to deal devastating blows.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="improveCrit">Improved Critical</span><p>Beginning when you choose this archetype at 3rd level, your weapon attacks score a critical hit on a roll of 19 or 20.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="remarkAth">Remarkable Athlete</span><p>Starting at 7th level, you can add half your proficiency bonus (round up) to any Strength, Dexterity, or Constitution check you make that doesn\'t already use your proficiency bonus.</p><p>In addition, when you make a running long jump, the distance you can cover increases by a number of feet equal to your Strength modifier.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="addFstyle">Additional Fighting Style</span><p>At 10th level, you can choose a second option from the Fighting Style class feature.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="supCrit">Superior Critical</span><p>Starting at 15th level, your weapon attacks score a critical hit on a roll of 18-20.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="survivor">Survivor</span><p>At 18th level, you attain the pinnacle of resilience in battle. At the start of each of your turns, you regain hit points equal to 5 + your Constitution modifier if you have no more than half of your hit points left. You don\'t gain this benefit if you have 0 hit points.</p></td></tr>']
        },{
            archetypeName: "<a href='#psiK'>Psi Knight</a>",
            archetypeFeatures: ["<a href='#psykAdt'>Psychokinesis Adept</a>","<a href='#psionicPower'>Psionic Power</a>", "<a href='#tkAdt'>Telekinetic Adept</a>", "<a href='#psiEnhancedMeta'>Psi-Enhanced Metabolism</a>","<a href='#bulwark'>Bulwark of Force</a>","<a href='#tkMaster'>Telekinetic Master</a>"],
            archetypeFeaturesDesc: ['<tr><td><span class="class-feature-title class-feature-archetype" id="psiK">Psi Knight</span><p>Awake to the psionic power within, a Psi Knight is a fighter who augments their physical might with psi-infused weapon strikes, telekinetic lashes, and barriers of mental force.</p><p>As a Psi Knight, you might have honed your psionic abilities through solo discipline, unlocked it under the tutelage of a master, or refined it at an academy dedicated to wielding the mind’s power as both weapon and shield.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="psykAdt">Psychokinesis Adept</span><p>You gain the Far Hand talent and can move twice as much weight with it. You can also leave objects suspended in mid-air from one round to another without them falling to the ground.</p><p>In addition, you can also use skills or tools in which you have proficiency with Far Hand instead of your hands, exchanging Dexterity for Intelligence and making the skill checks at disadvantage. You still need the proper tools.</p><p>The disadvantage is lost at 6th level, and you gain Advantage with them at 14th level.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="psionicPower">Psionic Power</span><p>You harbor a wellspring of psionic power within yourself. This energy ebbs and flows as you channel it in various ways and is represented by your Psionic Power die, the starting size of which is a d6.</p><p><b>Psionic Power Options. </b>You can use your Psionic Power die in the following ways:</p><p><b>Protective Field. </b>When you or another creature you can see within 30 feet of you takes damage, you can use your reaction to roll your Psionic Power die and reduce the damage taken by the number rolled plus your Intelligence modifier (minimum reduction of 1),  as you create a momentary shield of telekinetic force.</p><p><b>Psi-Powered Leap. </b>When you make a high or long jump, you can roll your Psionic Power die and extend the distance of the jump, up to a number of feet equal to twice the number rolled plus twice your Intelligence modifier (minimum of 1 extra foot). This extra distance costs you only 1 foot of movement.</p><p><b>Telekinetic Strike. </b>You can propel your attacks with  telekinetic force. Once on each of your turns, immediately after you deal damage to a target within 30 feet of you with a weapon attack, you can roll your Psionic Power die and also deal force damage to the target equal to the number rolled.</p><p><b>Changing the Die’s Size. </b>If you roll the highest number on your Psionic Power die, it decreases by one die size after the roll. This represents you burning through your psionic energy. For example, if the die is a d6 and you roll a 6, it becomes a d4. If it’s a d4 and you roll a 4, it becomes unusable until you finish a long rest. Conversely, if you roll a 1 on your Psionic Power die, it increases by one die size after the roll, up to its starting size. This represents you conserving psionic energy for later use. For example, if you roll a 1 on a d4, the die then becomes a d6.</p><p>Whenever you finish a long rest, your Psionic Power die resets to its starting size. When you reach certain levels in this class, the starting size of your Psionic Power die increases: at 5th level (d8), 11th level (d10), and 17th level (d12).</p><p><b>Psi Replenishment. </b>As a bonus action, you can calm your mind for a moment and restore your Psionic Power die to its starting size. You then can’t use Psi Replenishment again until you finish a long rest.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="tkAdt">Telekinetic Adept</span><p>You have mastered new ways to use your telekinesis.</p><p><b>Psionic Thrust. </b>When you deal damage to a target that is up to one size larger than yourself with the Telekinetic Strike of your Psionic Power, you can force the target to make a Strength saving throw against a DC equal to 8 + your proficiency bonus + your Intelligence modifier. Unless the save succeeds, you can knock the target prone or move it up to 10 feet in any direction horizontally.</p><p><b>Telekinetic Movement. </b>If your Psionic Power die is available, you can move an object or a creature with your mind. As an action, you target one loose object that is Large or smaller or one willing creature, other than yourself. If you can see the target and it is within 30 feet of you, you can move it up to 30 feet to an unoccupied space you can see. Alternatively, if it is a Tiny object, you can move it to or from your hand. Either way, you can move the target horizontally, vertically, or both. When you take this action, your Psionic Power die decreases by one die size.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="psiEnhancedMeta">Psi-Enhanced Metabolism</span><p>The psionic energy flowing through you has bolstered your mind and body. You have resistance to poison and psychic damage, and you are immune to the poisoned condition.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="bulwark">Bulwark of Force</span><p>You can shield yourself and others with telekinetic force. As a bonus action, you can choose creatures, which can include you, that you can see within 30 feet of you, up to a number of creatures equal to your Intelligence modifier (minimum of one creature). Each of the chosen creatures is protected by half cover for 1 minute or until you’re incapacitated.</p><p>Once you use this feature, you can’t do so again until you finish a long rest, unless you decrease your Psionic Power die by one die size to use this feature again.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="tkMaster">Telekinetic Master</span><p>Your ability to move creatures and objects with your mind is matched by few. If your Psionic Power die is available, you can move or manipulate creatures or objects within 60 feet of you by thought. For up to ten minutes, you can use your action to exert your will causing the appropriate effect below. You can affect the same target round after round or choose a new one at any time. If you switch targets, the prior target is no longer affected.</p><p><b></b>Objects. As an action, you can try to move an object that weighs up to 1,000 pounds. If the object isn\'t being worn or carried, you automatically move it up to 30 feet in any direction, but not beyond 60 feet of you and you must keep the object within sight during this movement.</p><p>If the object is worn or carried by a creature, you must make an Intelligence check contested by that creature\'s Strength check. If you succeed, you pull the object away from that creature and can move it up to 30 feet in any direction but not beyond 60 feet of you.</p><p>You can exert fine control on objects with your telekinetic grip, such as manipulating a simple tool, opening a door or a container, stowing or retrieving an item from an open container, or pouring the contents from a vial.</p><p><b></b>Creature. You can try to move a Huge or smaller creature. Make an Intelligence check contested by the creature\'s Strength check. If you win the contest, you move the creature up to 30 feet in any direction, including upward but not 60 feet of you. Until the end of your next turn, the creature is restrained in your telekinetic grip. A creature lifted upward is suspended in mid-air.</p><p>On subsequent rounds, you can use your action to attempt to maintain your telekinetic grip on the creature by repeating the contest.</p><p>When you use this ability, your Psionic Power die decreases by one die size.</p></td></tr>']
        },{
            ...
            archetypeFeaturesDesc: ['<tr><td><span class="class-feature-title class-feature-archetype" id="sharpshooter">Sharpshooter</span><p>The Sharpshooter is a master of ranged combat. An excellent sniper and eagle-eyed scout, this fighter is a perilous foe who can defeat an entire war band so long as they are kept at range.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="steadyAim">Steady Aim</span><p>Your aim becomes deadly. As a bonus action on your turn, you can take careful aim at a creature you can see that is within range of a ranged weapon you\'re wielding. Until the end of this turn, your ranged attacks with that weapon gain two benefits against the target:</p><ul><li>The attacks ignore half and three-quarters cover.</li><li>On each hit, the weapon deals additional damage to the target equal to 2 + half your fighter level.</li></ul><p>You can use this feature three times. You regain all expended uses of it when you finish a short or long rest.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="carefulEye">Careful Eyes</span><p>Your sharp eyes help you detect important information. You gain proficiency in the Perception, Investigation, or Survival skill (choose one). If you already have proficiency in your choice of skill, your proficiency bonus is doubled for any ability check you make that uses the chosen proficiencies.</p><p>In addition, your years of training in  different environments and lighting conditions has honed your vision. You now have darkvision within 60 feet, and if you already have darkvision, it is extended by 30 feet.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="closeQuarters">Close-Quarters Shooting</span><p>You learn to handle yourself in close combat. Making a ranged attack roll while within 5 feet of an enemy doesn’t impose disadvantage on your roll.</p><p>In addition, if you hit a creature within 5 feet of you with a ranged attack on your turn, that creature can’t take reactions until the end of this turn.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="calledShot">Called Shot</span><p>You learn to make the most of your shots. If you have advantage on a weapon attack against a target on your turn, you can forgo that advantage to add 3d6 weapon damage on a successful hit.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="snapShot">Snap Shot</span><p>You are ever ready to spring into action. If you take the Attack action on your first turn of a combat, you can make one additional ranged weapon attack as part of that action.</p></td></tr> ']
        },{
            ...
            archetypeFeaturesDesc: ['<tr><td><span class="class-feature-title class-feature-archetype" id="warcaller">Warcaller</span><p>As skilled with the musical note or the spoken word as they are with the blade, warcallers blend their skill at arms psionically with the power of song. Primarily serving as martial troops or bodyguards for tribe leaders, clan heads, or Keepers of knowledge, warcallers can be found nearly anywhere that an important individual would be. Though as skilled with instruments as other musicians, most warcallers find singing or chanting to be the most efficient and practical method of using their abilities, as this leaves their hands free to hold their weapons or shields.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="martialChant">Martial Chant</span><p>You gain proficiency in three musical instruments and the Performance skill. Additionally, you learn the Ego Assault talent. Your DC is 8 + your proficiency modifier + your Charisma modifier. Lastly, you can add double your proficiency bonus to all Performance checks that involve singing, chanting, or speaking.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="warsong">Warsong</span><p>You learn to fill your allies with vigor and might with your battle songs. To do so, you use a bonus action on your turn to choose one creature other than yourself within 60 feet of you who can hear you. That creature gains one Warsong die, a d6.</p><p>Once within the next 10 minutes, the creature can roll the die and add the number rolled to one ability check, attack roll, damage roll, or saving throw it makes. The creature can wait until after it rolls the d20 before deciding to use the Warsong die but must decide before the DM says whether the roll succeeds or fails. Once the Warsong die is rolled, it is lost. A creature can have only one Warsong die at a time.</p><p>You can use this feature a number of times equal to your Charisma modifier (a minimum of once). You regain any expended uses when you finish a long rest.</p><p>Your Warsong die changes when you reach certain levels in this class. The die becomes a d8 at 10th level, a d10 at 15th level, and a d12 at 18th level.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="cmtChanting">Combat Chanting</span><p>You learn to bolster yourself with the same vigor as your allies. Whenever you grant another creature a Warsong die, you gain one yourself. You also now regain all your expended uses of Warsong when you finish a short or long rest.</p><p>As well, whenever you use the Ego Assault talent on your turn, you can use your bonus action to make a single weapon attack.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="wallWords">Wall of Words</span><p>Whenever a creature that has a Warsong die you gave to them is hit by an attack, it can use its reaction to add that die roll to its AC, potentially causing the attack to miss.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="celeritousVocals">Celeritous Vocals</span><p>Any creature that has an unspent Warsong die that you granted it gains a +1 bonus to its AC and increases its speed by 10 feet.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="orator">Master Orator</span><p>When using your Warsong ability, you can target a number of additional creatures within range equal to your Charisma modifier, giving each of them a Warsong die.</p></td></tr>']
        }]
    };
    ...
    var monk = {
        ...
        featuresDesc:['<tr><td><span class="class-feature-title" id="unarmored">Unarmored Defense</span><p>Beginning at 1st level, while you are wearing no armor and not wielding a shield, your AC equals 10 + your Dexterity modifier + your Wisdom modifier.</p></td></tr>','<tr><td><span class="class-feature-title" id="martialArts">Martial Arts</span><p>Your practice of martial arts gives you mastery of combat styles that use unarmed strikes and monk weapons, which are shortswords and any simple melee weapons that don\'t have the two-handed or heavy property.</p><p>You gain the following benefits while you are unarmed or wielding only monk weapons and you aren\'t wearing armor or wielding a shield.</p><ul><li>You can use Dexterity instead of Strength for the attack and damage rolls of your unarmed strikes and monk weapons.</li><li>You can roll a d4 in place of the normal damage of your unarmed strike or monk weapon. This die changes as you gain monk levels, as shown in the Martial Arts column of the Monk table.</li><li>When you use the Attack action with an unarmed strike or a monk weapon on your turn, you can make one unarmed strike as a bonus action. For example, if you take the Attack action and attack with a quarterstaff, you can also make an unarmed strike as a bonus action, assuming you haven\'t already taken a bonus action this turn.</li></ul><p>Certain monasteries use specialized forms of the monk weapons. For example, you might use a club that is two lengths of wood connected by a short chain (called a nunchaku) or a sickle with a shorter, straighter blade (called a kama).</p></td></tr>','<tr><td><span class="class-feature-title" id="ki">Ki</span><p>Starting at 2nd level, your training allows you to harness the mystic energy of ki. Your access to this energy is represented by a number of ki points. Your monk level determines the number of points you have, as shown in the Ki Points column of the Monk table.</p><p>You can spend these points to fuel various ki features. You start knowing the following features: Flurry of Blows, Distant Eye, Ki-Fueled Strike, Patient Defense, and Step of the Wind. You learn more ki features as you gain levels in this class.</p><p>When you spend a ki point, it is unavailable until you finish a short or long rest, at the end of which you draw all of your expended ki back into yourself. You must spend at least 30 minutes of the rest meditating to regain your ki points.</p><p>Some of your ki features require your target to make a saving throw to resist the feature\'s effects. The saving throw DC is calculated as follows:</p><p class="text-center"><b>Ki save DC</b> = 8 + your proficiency bonus + your Wisdom modifier</p><span class="class-feature-subtitle">Distant Eye</span><p>When you make a ranged weapon attack, you can spend 1 ki point to prevent attacking at long range from imposing disadvantage on your attack rolls until the end of the current turn.</p><span class="class-feature-subtitle">Flurry of Blows</span><p>Immediately after you take the Attack action on your turn, you can spend 1 ki point to make two unarmed strikes as a bonus action.</p><span class="class-feature-subtitle">Ki-Fueled Strike</span><p>If you spend 1 ki or more as part of your action on your turn, you can then immediately make one unarmed strike as a bonus action.</p><span class="class-feature-subtitle">Patient Defense</span><p>You can spend 1 ki point to take the Dodge action as a bonus action on your turn.</p><span class="class-feature-subtitle">Step of the Wind</span><p>You can spend 1 ki point to take the Disengage or Dash action as a bonus action on your turn, and your jump distance is doubled for the turn.</p></td></tr>','<tr><td><span class="class-feature-title" id="unarmMove">Unarmored Movement</span><p>Starting at 2nd level, your speed increases by 10 feet while you are not wearing armor or wielding a shield. This bonus increases when you reach certain monk levels, as shown in the Monk table.</p><p>At 9th level, you gain the ability to move along vertical surfaces and across liquids on your turn without falling during the move.</p></td></tr>','<tr><td><span class="class-feature-title" id="deflect">Deflect Missiles</span><p>Starting at 3rd level, you can use your reaction to deflect or catch the missile when you are hit by a ranged weapon attack. When you do so, the damage you take from the attack is reduced by 1d10 + your Dexterity modifier + your monk level.</p><p>If you reduce the damage to 0, you can catch the missile if it is small enough for you to hold in one hand and you have at least one hand free. If you catch a missile in this way, you can spend 1 ki point to make a ranged attack (range 20/60 feet) with the weapon or piece of ammunition you just caught, as part of the same reaction. You make this attack with proficiency, regardless of your weapon proficiencies, and the missile counts as a monk weapon for the attack.</p></td></tr>','<tr><td><span class="class-feature-title" id="monasticTrad1">Monastic Tradition</span><p>When you reach 3rd level, you commit yourself to a monastic tradition, chosen from the list of available traditions. Your tradition grants you features at 3rd level and again at 6th, 11th, and 17th level.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi4">Ability Score Improvement</span><p>When you reach 4th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM allows the use of feats, you may instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="slowFall">Slow Fall</span><p>Beginning at 4th level, you can use your reaction when you fall to reduce any falling damage you take by an amount equal to five times your monk level.</p></td></tr>','<tr><td><span class="class-feature-title" id="xtraAttack">Extra Attack</span><p>Beginning at 5th level, you can attack twice, instead of once, whenever you take the Attack action on your turn.</p></td></tr>','<tr><td><span class="class-feature-title" id="stunningStr">Stunning Strike</span><p>Starting at 5th level, you can interfere with the flow of ki in an opponent\'s body. When you hit another creature with a melee weapon attack, you can spend 1 ki point to attempt a stunning strike. The target must succeed on a Constitution saving throw or be stunned until the end of your next turn.</p></td></tr>','<tr><td><span class="class-feature-title" id="kiEmpStrikes">Ki-Empowered Strikes</span><p>Starting at 6th level, your unarmed strikes count as magical for the purpose of overcoming resistance and immunity to nonmagical attacks and damage.</p></td></tr>','<tr><td><span class="class-feature-title" id="monasticTrad2">Monastic Tradition Feature</span><p>At 6th level, you gain one feature granted by your Monastic Tradition.</p></td></tr>','<tr><td><span class="class-feature-title" id="evasion">Evasion</span><p>At 7th level, your instinctive agility lets you dodge out of the way of certain area effects, such as a blue dragon\'s lightning breath or a fireball spell. When you are subjected to an effect that allows you to make a Dexterity saving throw to take only half damage, you instead take no damage if you succeed on the saving throw, and only half damage if you fail.</p></td></tr>','<tr><td><span class="class-feature-title" id="stillness">Stillness of Mind</span><p>Starting at 7th level, you can use your action to end one effect on yourself that is causing you to be charmed or frightened.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi8">Ability Score Improvement</span><p>When you reach 8th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM allows the use of feats, you may instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="unarmMoveImp">Unarmored Movement improvement</span><p>At 9th level, you gain the ability to move along vertical surfaces and across liquids on your turn without falling during the move.</p></td></tr>','<tr><td><span class="class-feature-title" id="pureBod">Purity of Body</span><p>At 10th level, your mastery of the ki flowing through you makes you immune to disease and poison.</p></td></tr>','<tr><td><span class="class-feature-title" id="monasticTrad3">Monastic Tradition Feature</span><p>At 11th level, you gain one feature granted by your Monastic Tradition.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi12">Ability Score Improvement</span><p>When you reach 12th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM allows the use of feats, you may instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="tongue">Tongue of the Sun and Moon</span><p>Starting at 13th level, you learn to touch the ki of other minds so that you understand all spoken languages. Moreover, any creature that can understand a language can understand what you say.</p></td></tr>','<tr><td><span class="class-feature-title" id="diamond">Diamond Soul</span><p>Beginning at 14th level, your mastery of ki grants you proficiency in all saving throws.</p><p>Additionally, whenever you make a saving throw and fail, you can spend 1 ki point to reroll it and take the second result.</p></td></tr>','<tr><td><span class="class-feature-title" id="timeless">Timeless Body</span><p>At 15th level, your ki sustains you so that you suffer none of the frailty of old age, and you can\'t be aged magically. You can still die of old age, however. In addition, you no longer need food or water.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi16">Ability Score Improvement</span><p>When you reach 16th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM allows the use of feats, you may instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="monasticTrad4">Monastic Tradition Feature</span><p>At 17th level, you gain one feature granted by your Monastic Tradition.</p></td></tr>','<tr><td><span class="class-feature-title" id="empty">Empty Body</span><p>Beginning at 18th level, you can use your action to spend 4 ki points to become invisible for 1 minute. During that time, you also have resistance to all damage but force damage.</p><p>Additionally, you can spend 8 ki points to cast the astral projection spell, without needing material components. When you do so, you can\'t take any other creatures with you.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi19">Ability Score Improvement</span><p>When you reach 19th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM allows the use of feats, you may instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="perfect">Perfect Self</span><p>At 20th level, when you roll for initiative and have no ki points remaining, you regain 4 ki points.</p></td></tr>'],
        archetypes:[{
            ...
            archetypeFeaturesDesc: ['<tr><td><span class="class-feature-title class-feature-archetype" id="drunkenMaster">Way of the Drunken Master</span><p>The Way of the Drunken Master teaches its students to move with the jerky, unpredictable movements of a drunkard. A drunken master sways, tottering on unsteady feet, to present what seems like an incompetent combatant who proves frustrating to engage. The drunken master\'s erratic stumbles conceal a carefully executed dance of blocks, parries, advances, attacks, and retreats.</p><p>A drunken master often enjoys playing the fool to bring gladness to the despondent or to demonstrate humility to the arrogant, but when battle is joined, the drunken master can be a maddening, masterful foe.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="bonusProf">Bonus Proficiencies</span><p>When you choose this tradition at 3rd level, you gain proficiency in the Performance skill if you don\'t already have it. Your martial arts technique mixes combat training with the precision of a dancer and the antics of a jester. You also gain proficiency with brewer\'s supplies if you don\'t already have it.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="drunkTech">Drunken Technique</span><p>At 3rd level, you learn how to twist and turn quickly as part of your Flurry of Blows. Whenever you use Flurry of Blows, you gain the benefit of the Disengage action, and your walking speed increases by 10 feet until the end of the current turn.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="tipsy">Tipsy Sway</span><p>Starting at 6th level, you can move in sudden, swaying ways. You gain the following benefits.</p><p><b>Leap to Your Feet.</b> When you\'re prone, you can stand up by spending 5 feet of movement, rather than half your speed.</p><p><b>Redirect Attack.</b> When a creature misses you with a melee attack roll, you can spend 1 ki point as a reaction to cause that attack to hit one creature of your choice, other than the attacker, that you can see within 5 feet of you.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="drunkard">Drunkard\'s Luck</span><p>Starting at 11th level, you always seem to get a lucky bounce at the right moment. When you make an ability check, an attack roll, or a saving throw and have disadvantage on the roll, you can spend 2 ki points to cancel the disadvantage for that roll.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="intoxicated">Intoxicated Frenzy</span><p>At 17th level, you gain the ability to make an overwhelming number of attacks against a group of enemies. When you use your Flurry of Blows, you can make up to three additional attacks with it (up to a total of five Flurry of Blows attacks), provided that each Flurry of Blows attack targets a different creature this turn.</p></td></tr>']
        },{
            ...
            archetypeFeaturesDesc: ['<tr><td><span class="class-feature-title class-feature-archetype" id="kensei">Way of the Kensei</span><p>Monks of the Way of the Kensei train relentlessly with their weapons, to the point where the weapon becomes an extension of the body. Founded on a mastery of sword fighting, the tradition has expanded to include many different weapons.</p><p>A kensei sees a weapon in much the same way a calligrapher or painter regards a pen or brush. Whatever the weapon, the kensei views it as a tool used to express the beauty and precision of the martial arts. That such mastery makes a kensei a peerless warrior is but a side effect of intense devotion, practice, and study.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="path">Path of the Kensei</span><p>When you choose this tradition at 3rd level, your special martial arts training leads you to master the use of certain weapons. This path also includes instruction in the deft strokes of calligraphy or painting. You gain the following benefits.</p><p><b>Kensei Weapons.</b> Choose two types of weapons to be your kensei weapons: one melee weapon and one ranged weapon. Each of these weapons can be any simple or martial weapon that lacks the heavy and special properties. The longbow is also a valid choice. You gain proficiency with these weapons if you don\'t already have it. Weapons of the chosen types are monk weapons for you. Many of this tradition\'s features work only with your kensei weapons. When you reach 6th, 11th, and 17th level in this class, you can choose another type of weapon—either melee or ranged—to be a kensei weapon for you, following the criteria above.</p><p><b>Agile Parry.</b> If you make an unarmed strike as part of the Attack action on your turn and are holding a kensei weapon, you can use it to defend yourself if it is a melee weapon. You gain a +2 bonus to AC until the start of your next turn, while the weapon is in your hand and you aren\'t incapacitated.</p><p><b>Kensei\'s Shot.</b> You can use a bonus action on your turn to make your ranged attacks with a kensei weapon more deadly. When you do so, any target you hit with a ranged attack using a kensei weapon takes an extra 1d4 damage of the weapon\'s type. You retain this benefit until the end of the current turn.</p><p><b>Way of the Brush.</b> You gain proficiency with Artist\'s Supplies.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="oneBlade">One with the Blade</span><p>At 6th level, you extend your ki into your kensei weapons, granting you the following benefits.</p><p><b>Magic Kensei Weapons.</b> Your attacks with your kensei weapons count as magical for the purpose of overcoming resistance and immunity to nonmagical attacks and damage.</p><p><b>Deft Strike.</b> When you hit a target with a kensei weapon, you can spend 1 ki point to cause the weapon to deal extra damage to the target equal to your Martial Arts die. You can use this feature only once on each of your turns.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="sharpen">Sharpen the Blade</span><p>At 11th level, you gain the ability to augment your weapons further with your ki. As a bonus action, you can expend up to 3 ki points to grant one kensei weapon you touch a bonus to attack and damage rolls when you attack with it. The bonus equals the number of ki points you spent. This bonus lasts for 1 minute or until you use this feature again. This feature has no effect on a magic weapon that already has a bonus to attack and damage rolls.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="accuracy">Unerring Accuracy</span><p>At 17th level, your mastery of weapons grants you extraordinary accuracy. If you miss with an attack roll using a monk weapon on your turn, you can reroll it. You can use this feature only once on each of your turns.</p></td></tr>']
        },{
            ...
            archetypeFeaturesDesc: ['<tr><td><span class="class-feature-title class-feature-archetype" id="death">Way of the Long Death</span><p>Monks of the Way of the Long Death are obsessed with the meaning and mechanics of dying. They capture creatures and prepare elaborate experiments to capture, record, and understand the moments of their demise. They use this knowledge to guide their understanding of martial arts, yielding a deadly fighting style.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="touch">Touch of Death</span><p>Starting when you choose this tradition at 3rd level, your study of death allows you to extract vitality from another creature as it nears its demise. When you reduce a creature within 5 feet of you to 0 hit points, you gain temporary hit points equal to your Wisdom modifier + your monk level (minimum of 1 temporary hit point).</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="reaping">Hour of Reaping</span><p>At 6th level, you gain the ability to unsettle or terrify those around you as an action, for your soul has been touched by the shadow of death. When you take this action, each creature within 30 feet of you that can see you must succeed on a Wisdom saving throw or be frightened of you until the end of your next turn.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="mastery">Mastery of Death</span><p>Beginning at 11th level, you use your familiarity with death to escape its grasp. When you are reduced to 0 hit points, you can expend 1 ki point (no action required) to have 1 hit point instead.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="longDeath">Touch of the Long Death</span><p>Starting at 17th level, your touch can channel the energy of death into a creature. As an action, you touch one creature within 5 feet of you, and you expend 1 to 10 ki points. The target must make a Constitution saving throw, and it takes 2d10 necrotic damage per ki point spent on a failed save, or half as much damage on a successful one.</p></td></tr>']
        },{
            ...
            archetypeFeaturesDesc: ['<tr><td><span class="class-feature-title class-feature-archetype" id="openHand">Way of the Open Hand</span><p>Monks of the Way of the Open Hand are the ultimate masters of martial arts combat, whether armed or unarmed. They learn techniques to push and trip their opponents, manipulate ki to heal damage to their bodies, and practice advanced meditation that can protect them from harm.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="openTech">Open Hand Technique</span><p>You can manipulate your enemy\'s ki when you harness your own. Whenever you hit a creature with one of the attacks granted by your Flurry of Blows, you can impose one of the following effects on that target.</p><ul><li>It must succeed on a Dexterity saving throw or be knocked prone.</li><li>It must make a Strength saving throw. If it fails, you can push it up to 15 feet away from you.</li><li>It can\'t take reactions until the end of your next turn.</li></ul></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="wholeness">Wholeness of Body</span><p>You gain the ability to heal yourself. As an action, you can regain hit points equal to three times your monk level. You must finish a long rest before you can use this feature again.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="protective">Protective Hand</span><p>You can tap into your ki reservoir to create a protective barrier. So long as you have at least 1 ki, you may use a reaction against an incoming attack (even if you are surprised). You extend your ki reserves to create an invisible globe with a radius of 15 feet centered on you.</p><p>Nothing can pass the barrier until your next turn including physical attacks, creatures or energy of any type. Any projectile stops in the middle of the air and falls to the ground, and any creatures captured crossing the barrier are pushed back, and Large or smaller creatures are also knocked prone.</p><p>Once you use this feature, you cannot do so again until you complete a short or long rest.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="palm">Quivering Palm</span><p>You gain the ability to set up lethal vibrations in someone\'s body. When you hit a creature with an unarmed strike, you can spend 3 ki points to start these imperceptible vibrations, which last for a number of days equal to your monk level. The vibrations are harmless unless you use your action to end them. To do so, you and the target must be on the same plane of existence. When you use this action, the creature must make a Constitution saving throw. If it fails, it is reduced to 0 hit points. If it succeeds, it takes 10d10 necrotic damage.</p><p>You can have only one creature under the effect of this feature at a time. You can choose to end the vibrations harmlessly without using an action.</p></td></tr>']
        },{
    ...
    var ranger = {
        ...
        archetypes:[{
            ...
            archetypeFeaturesDesc: ['<tr><td><span class="class-feature-title class-feature-archetype" id="dervish">Dervish</span><p>You are one of the legendary Dervish: fierce, lighting fast warriors who call the desert their home. Though there are others who profess skill at fighting with a pair of weapons, there are none that compare to the absolute mastery of the style the dervish hold. As well, they excel at both distraction and misdirection, and seem to be able to bend the sands of their homeland to their whim.</p><p><b>Prerequisites: </b>Two-Weapon Fighting style.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="sprinter">Sand Sprinter</span><p>Moving through sand and similar materials cost you no extra movement. Additionally, your base walking speed increases by 5 feet. At 7th level, this movement speed bonus increases to 10 feet, and at 15th level it increases to 15 feet.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="dance">Dervish Dance</span><p>If you have moved at least 10 feet toward a target on your turn, you can attack twice instead of once when you use your bonus action to engage in two-weapon fighting using two light weapons. The movement must be made before triggering your bonus action to attack. The extra attack is made at disadvantage until you reach 11th level.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="sandstorm">Sandstorm</span><p>You learn to kick up an obscuring cloud of sand around yourself while you move. When you move more than 15 feet on your turn, you can use an action and 1 scrap to cause your space to become heavily obscured until the start of your next turn. Your ability to see is unhindered by this effect.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="sirocco">Sirocco</span><p>While wielding a light melee weapon in each hand, you can use your action to make a melee attack against any number of creatures within 5 feet of you, with a separate attack roll for each target.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="swimmer">Dune Swimmer</span><p>You learn the secret of moving through the dunes. You gain a burrow speed in sand and similar materials equal to half your walking speed. While burrowing, you gain tremorsense of 15 feet, and you can breathe for up to 1 minute while submerged by using 2 scrap. Once per turn, if you exit the sand next to a foe on your turn, you gain advantage on your first attack against that creature.</p></td></tr>']
        },{
    ...
    var rogue = {
        ...
        featuresDesc:['<tr><td><span class="class-feature-title" id="expertise1">Expertise</span><p>At 1st level, choose two of your skill proficiencies, or one of your skill proficiencies and your proficiency with thieves\' tools. Your proficiency bonus is doubled for any ability check you make that uses either of the chosen proficiencies.</p><p>At 6th level, you can choose two more of your proficiencies (in skills or with thieves\' tools) to gain this benefit.</p></td></tr>','<tr><td><span class="class-feature-title" id="sneak">Sneak Attack</span><p>Beginning at 1st level, you know how to strike subtly and exploit a foe\'s distraction. Once per turn, you can deal an extra 1d6 damage to one creature you hit with an attack if you have advantage on the attack roll. The attack must use a finesse or a ranged weapon.</p><p>You don\'t need advantage on the attack roll if another enemy of the target is within 5 feet of it, that enemy isn\'t incapacitated, and you don\'t have disadvantage on the attack roll.</p><p>The amount of the extra damage increases as you gain levels in this class, as shown in the Sneak Attack column of the Rogue table.</p></td></tr>','<tr><td><span class="class-feature-title" id="cant">Thieves\' Cant</span><p>During your rogue training you learned thieves\' cant, a secret mix of dialect, jargon, and code that allows you to hide messages in seemingly normal conversation. Only another creature that knows thieves\' cant understands such messages. It takes four times longer to convey such a message than it does to speak the same idea plainly.</p><p>In addition, you understand a set of secret signs and symbols used to convey short, simple messages, such as whether an area is dangerous or the territory of a thieves\' guild, whether loot is nearby, or whether the people in an area are easy marks or will provide a safe house for thieves on the run.</p></td></tr>','<tr><td><span class="class-feature-title" id="cunning">Cunning Action</span><p>Starting at 2nd level, your quick thinking and agility allow you to move and act quickly. You can take a bonus action on each of your turns in combat. This action can be used only to take the Dash, Disengage, or Hide action.</p></td></tr>','<tr><td><span class="class-feature-title" id="aim">Cunning Action: Aim</span><p>You gain an additional way to use your Cunning Action: carefully aiming your next attack. As a bonus action, you give yourself advantage on your next attack roll on the current turn. You can use this bonus action only if you haven\'t moved during this turn, and after you use the bonus action, your speed is 0 until the end of the current turn.</p></td></tr>','<tr><td><span class="class-feature-title" id="archetype">Roguish Archetype</span><p>At 3rd level, you choose an archetype that you emulate in the exercise of your rogue abilities from the list of available archetypes. Your archetype choice grants you features at 3rd level and then again at 9th, 13th, and 17th level.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi4">Ability Score Improvement</span><p>When you reach 4th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM allows the use of feats, you may instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="dodge">Uncanny Dodge</span><p>Starting at 5th level, when an attacker that you can see hits you with an attack, you can use your reaction to halve the attack\'s damage against you.</p></td></tr>','<tr><td><span class="class-feature-title" id="expertise2">Expertise</span><p>At 6th level, you can choose two more of your proficiencies (in skills or with thieves\' tools) to gain the benefit of Expertise.</p></td></tr>','<tr><td><span class="class-feature-title" id="evasion">Evasion</span><p>Beginning at 7th level, you can nimbly dodge out of the way of certain area effects, such as a red dragon\'s fiery breath or an ice storm spell. When you are subjected to an effect that allows you to make a Dexterity saving throw to take only half damage, you instead take no damage if you succeed on the saving throw, and only half damage if you fail.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi8">Ability Score Improvement</span><p>When you reach 8th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM allows the use of feats, you may instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="archetypeFeature1">Roguish Archetype Feature</span><p>At 9th level, you gain a feature granted by your Roguish Archetype.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi10">Ability Score Improvement</span><p>When you reach 10th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM allows the use of feats, you may instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="talent">Reliable Talent</span><p>By 11th level, you have refined your chosen skills until they approach perfection. Whenever you make an ability check that lets you add your proficiency bonus, you can treat a d20 roll of 9 or lower as a 10.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi12">Ability Score Improvement</span><p>When you reach 12th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM allows the use of feats, you may instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="archetypeFeature2">Roguish Archetype Feature</span><p>At 13th level, you gain a feature granted by your Roguish Archetype.</p></td></tr>','<tr><td><span class="class-feature-title" id="blindsense">Blindsense</span><p>Starting at 14th level, if you are able to hear, you are aware of the location of any hidden or invisible creature within 10 feet of you.</p></td></tr>','<tr><td><span class="class-feature-title" id="slippery">Slippery Mind</span><p>By 15th level, you have acquired greater mental strength. You gain proficiency in Wisdom saving throws.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi16">Ability Score Improvement</span><p>When you reach 16th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM allows the use of feats, you may instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="archetypeFeature3">Roguish Archetype Feature</span><p>At 17th level, you gain a feature granted by your Roguish Archetype.</p></td></tr>','<tr><td><span class="class-feature-title" id="elusive">Elusive</span><p>Beginning at 18th level, you are so evasive that attackers rarely gain the upper hand against you. No attack roll has advantage against you while you aren\'t incapacitated.</p></td></tr>','<tr><td><span class="class-feature-title" id="asi19">Ability Score Improvement</span><p>When you reach 19th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can\'t increase an ability score above 20 using this feature.</p><p>If your DM allows the use of feats, you may instead take a feat.</p></td></tr>','<tr><td><span class="class-feature-title" id="luck">Stroke of Luck</span><p>At 20th level, you have an uncanny knack for succeeding when you need to. If your attack misses a target within range, you can turn the miss into a hit. Alternatively, if you fail an ability check, you can treat the d20 roll as a 20.</p><p>Once you use this feature, you can\'t use it again until you finish a short or long rest.</p></td></tr>'],
        archetypes:[{
            ...
            archetypeFeaturesDesc: ['<tr><td><span class="class-feature-title class-feature-archetype" id="assassin">Assassin</span><p>You focus your training on the grim art of death. Those who adhere to this archetype are diverse - hired killers, spies, bounty hunters, and even specially anointed priests trained to exterminate the enemies of their deity. Stealth, poison, and disguise help you eliminate your foes with deadly efficiency.</p><p>Your archetype grants you features at 3rd level and then again at 9th, 13th, and 17th level.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="assassinate">Assassinate</span><p>Starting at 3rd level, you are at your deadliest when you get the drop on your enemies. You have advantage on attack rolls against any creature that hasn\'t taken a turn in the combat yet. In addition, any hit you score against a creature that is surprised is a critical hit.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="bonusProf">Bonus Proficiencies</span><p>When you choose this archetype at 3rd level, you gain proficiency with the disguise kit and the poisoner\'s kit.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="infiltration">Infiltration Expertise</span><p>Starting at 9th level, you can unfailingly create false identities for yourself. You must spend seven days and 25 gp to establish the history, profession, and affiliations for an identity. You can\'t establish an identity that belongs to someone else. For example, you might acquire appropriate clothing, letters of introduction, and official-looking certification to establish yourself as a member of a trading house from a remote city so you can insinuate yourself into the company of other wealthy merchants.</p><p>Thereafter, if you adopt the new identity as a disguise, other creatures believe you to be that person until given an obvious reason not to.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="impostor">Impostor</span><p>At 13th level, you gain the ability to unerringly mimic another person\'s speech, writing, and behavior. You must spend at least three hours studying these three components of the person\'s behavior, listening to speech, examining handwriting, and observing mannerism.</p><p>Your ruse is indiscernible to the casual observer. If a wary creature suspects something is amiss, you have advantage on any Charisma (Deception) check you make to avoid detection.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="death">Death Strike</span><p>Starting at 17th level, you become a master of instant death. When you attack and hit a creature that is surprised, it must make a Constitution saving throw (DC 8 + your Dexterity modifier + your proficiency bonus). On a failed save, double the damage of your attack against the creature.</p></td></tr>']
        },{
            ...
            archetypeFeaturesDesc: ['<tr><td><span class="class-feature-title class-feature-archetype" id="inquisitive">Inquisitive</span><p>As an archetypal Inquisitive, you excel at rooting out secrets and unraveling mysteries. You rely on your sharp eye for detail, but also on your finely honed ability to read the words and deeds of other creatures to determine their true intent. You excel at defeating creatures that hide among and prey upon ordinary folk, and your mastery of lore and your keen deductions make you well equipped to expose and end hidden evils.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="deceit">Ear for Deceit</span><p>When you choose this archetype at 3rd level, you develop a talent for picking out lies. Whenever you make a Wisdom (Insight) check to determine whether a creature is lying, treat a roll of 7 or lower on the d20 as an 8.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="detail">Eye for Detail</span><p>Starting at 3rd level, you can use a bonus action to make a Wisdom (Perception) check to spot a hidden creature or object or to make an Intelligence (Investigation) check to uncover or decipher clues.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="insightful">Insightful Fighting</span><p>At 3rd level, you gain the ability to decipher an opponent\'s tactics and develop a counter to them. As a bonus action, you can make a Wisdom (Insight) check against a creature you can see that isn\'t incapacitated, contested by the target\'s Charisma (Deception) check. If you succeed, you can use your Sneak Attack against that target even if you don\'t have advantage on the attack roll, but not if you have disadvantage on it.</p><p>This benefit lasts for 1 minute or until you successfully use this feature against a different target.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="steady">Steady Eye</span><p>Starting at 9th level, you have advantage on any Wisdom (Perception) or Intelligence (Investigation) check if you move no more than half your speed on the same turn.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="unerring">Unerring Eye</span><p>Beginning at 13th level, your senses are almost impossible to foil. As an action, you sense the presence of illusions, shapechangers not in their original form, and other magic designed to deceive the senses within 30 feet of you, provided you aren\'t blinded or deafened. You sense that an effect is attempting to trick you, but you gain no insight into what is hidden or into its true nature.</p><p>You can use this feature a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses of it when you finish a long rest.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="weakness">Eye for Weakness</span><p>At 17th level, you learn to exploit a creature\'s weaknesses by carefully studying its tactics and movement. While your Insightful Fighting feature applies to a creature, your Sneak Attack damage against that creature increases by 3d6.</p></td></tr>']
        },{
            archetypeName: "<a href='#psiAssassin'>Psi Assassin</a>",
            archetypeFeatures: ["<a href='#farhanded'>Farhanded</a>","<a href='#psipower'>Psionic Power</a>","<a href='#psyBlades'>Psychic Blades</a>","<a href='#soulBlades'>Soul Blades</a>","<a href='#veil'>Psionic Veil</a>","<a href='#rendMind'>Rend Mind</a>"],
            archetypeFeaturesDesc: ['<tr><td><span class="class-feature-title class-feature-archetype" id="psiAssassin">Psi Assassin</span><p>Most assassins strike with physical weapons, and many burglars and spies use thieves’ tools to infiltrate secure locations, whereas a Psi Assassin strikes and infiltrates with the mind, cutting through barriers both physical and psychic. These rogues discover psionic power within themselves and channel it to do their roguish work. They find easy employment as members of a tribal leader’s spy network, though they are often mistrusted by less able spies or more physical assassins.</p><p>Your psionic abilities might have haunted you since you were a child, only revealing their potential as you experienced the stress of adventure. Or you might have sought out a reclusive order of psionic adepts and spent years learning how to manifest your power.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="farhanded">Farhanded</span><p>You know the Far Hand talent and you can perform the following additional tasks with it:</p><ul><li>You can stow one object the hand is holding in a container worn or carried by another creature.</li><li>You can retrieve an object in a container worn or carried by another creature.</li><li>You can use thieves\' tools to pick lock and disarm traps at range.</li></ul><p>You can perform one of these tasks without being noticed by a creature if you succeed on a Dexterity (Sleight of Hand) check contested by the creature\'s Wisdom (Perception) check.</p><p>In addition, you can use the bonus action granted by your Cunning Action to control the hand.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="psipower">Psionic Power</span><p>You harbor a wellspring of psionic power within yourself. The energy that ebbs and flows as you channel it in various ways is represented by your Psionic Power die, the starting size of which is a d6.</p><p><b>Psionic Power Options.</b> You can use your Psionic Power die in the following ways:</p><p><b>Psi-Bolstered Knack.</b> When your non-psionic training fails you, you can tap into your psionic power to help: if you fail an ability check using a skill or tool with which you have proficiency, you can roll your Psionic Power die and add the number rolled to the check, potentially turning failure into success.</p><p><b>Psychic Whispers.</b> You can use your psychic abilities to establish telepathic communication between yourself and others—perfect for quiet infiltration. As an action, you give yourself and at least one other creature the ability to speak telepathically with each other. When you do so, roll your Psionic Power die, and choose creatures you can see, up to a number of creatures equal to the number rolled. For 1 hour, the chosen creatures can speak telepathically with you, and you can speak telepathically with them. To send or receive a message (no action required), you and the other creature must be within 1 mile of each other. A creature can’t use this telepathy if it can’t speak any languages, and a creature can end the telepathic connection at any time (no action required). You and the creature don’t need to speak a common language to understand each other.</p><p><b>Changing the Die’s Size.</b> If you roll the highest number on your Psionic Power die, it decreases by one die size after the roll. This represents you burning through your psionic energy. For example, if the die is a d6 and you roll a 6, it becomes a d4. If it’s a d4 and you roll a 4, it becomes unusable until you finish a long rest.</p><p>Conversely, if you roll a 1 on your Psionic Power die, it increases by one die size after the roll, up to its starting size. This represents you conserving psionic energy for later use. For example, if you roll a 1 on a d4, the die then becomes a d6.</p><p>Whenever you finish a long rest, your Psionic Power die resets to its starting size. When you reach certain levels in this class, the starting size of your Psionic Power die increases: at 5th level (d8), 11th level (d10), and 17th level (d12).</p><p><b>Psi Replenishment.</b> As a bonus action, you can calm your mind for a moment and restore your Psionic Power die to its starting size. You then cannot use Psi Replenishment again until you finish a long rest.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="psyBlades">Psychic Blades</span><p>You can manifest your psionic power as shimmering blades of psychic energy. When you are about to make a melee or ranged weapon attack against a creature, you can manifest a psychic blade from your free hand and make the attack with that blade. This magic blade is a simple melee weapon with the finesse and thrown properties. It has a maximum range of 60 feet, and on a hit, it deals psychic damage equal to 1d6 plus the ability modifier you used for the attack roll. The blade vanishes immediately after it hits or misses its target, and it leaves no mark on its target if it deals damage.</p><p>After you attack with the blade, you can make a melee or ranged weapon attack with a second psychic blade as a bonus action on the same turn, provided your other hand is free to create it. The damage die of this bonus attack is 1d4, instead of 1d6, plus the ability modifier you used for the attack roll.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="soulBlades">Soul Blades</span><p>Your Psychic Blades are now an expression of your psi-suffused soul, giving you finer control over them in the following ways:</p><p><b>Homing Strikes.</b> If you make an attack roll with your Psychic Blades and miss the target, you can roll your Psionic Power die and add the number rolled to the attack roll. If this causes the attack to hit, your Psionic Power die decreases by one die size, regardless of the number rolled.</p><p><b>Psychic Teleportation.</b> If your Psionic Power die is available, you can hurl your Psychic Blades to magically transport yourself to another location. As a bonus action, you manifest one of your Psychic Blades and throw it at an unoccupied space you can see, up to a number of feet away equal to 5 times the highest number on your Psionic Power die. You then teleport to that space, the blade vanishes, and your Psionic Power die decreases by one die size.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="veil">Psionic Veil</span><p>You can weave a veil of psychic static to mask yourself. As an action, you can magically become invisible, along with anything you are wearing or carrying, for 10 minutes or until you dismiss this effect (no action required). This invisibility ends if you deal damage to a creature or if you force a creature to make a saving throw.</p><p>Once you use this feature, you can’t do so again until you finish a long rest, unless you decrease your Psionic Power die by one die size to use this feature again.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="rendMind">Rend Mind</span><p>You can sweep your Psychic Blades directly through a creature’s mind. When you use your Psychic Blades to deal Sneak Attack damage to a creature, you can force that target to make a Wisdom saving throw (DC equal to 8 + your proficiency bonus + your Dexterity modifier). Unless the save succeeds, the target is stunned until the end of your next turn.</p><p>Once you use this feature, you can’t do so again until you finish a long rest, unless you decrease your Psionic Power die by one die size to use this feature again.</p></td></tr>']
        },{
            ...
            archetypeFeaturesDesc: ['<tr><td><span class="class-feature-title class-feature-archetype" id="scout">Scout</span><p>You are skilled in stealth and surviving far from the streets of a city, allowing you to scout ahead of your companions during expeditions. Rogues who embrace this archetype are at home in the wilderness and among barbarians and rangers, and many Scouts serve as the eyes and ears of war bands. Ambusher, spy, bounty hunter—these are just a few of the roles that Scouts assume as they range the world.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="skirmisher">Skirmisher</span><p>Starting at 3rd level, you are difficult to pin down during a fight. You can move up to half your speed as a reaction when an enemy ends its turn within 5 feet of you. This movement doesn\'t provoke opportunity attacks.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="survivalist">Survivalist</span><p>When you choose this archetype at 3rd level, you gain proficiency in the Nature and Survival skills if you don\'t already have it. Your proficiency bonus is doubled for any ability check you make that uses either of those proficiencies.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="mobility">Superior Mobility</span><p>At 9th level, your walking speed increases by 10 feet. If you have a climbing or swimming speed, this increase applies to that speed as well.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="ambush">Ambush Master</span><p>Starting at 13th level, you excel at leading ambushes and acting first in a fight.</p><p>You have advantage on initiative rolls. In addition, the first creature you hit during the first round of a combat becomes easier for you and others to strike; attack rolls against that target have advantage until the start of your next turn.</p></td></tr>','<tr><td><span class="class-feature-subtitle class-feature-archetype" id="sudden">Sudden Strike</span><p>Starting at 17th level, you can strike with deadly speed. If you take the Attack action on your turn, you can make one additional attack as a bonus action. This attack can benefit from your Sneak Attack even if you have already used it this turn, but you can\'t use your Sneak Attack against the same target more than once in a turn.</p></td></tr>']
        }]
    };
